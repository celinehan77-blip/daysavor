...
- `ghcr.io/celinehan77-blip/recipe-ticket-app-v2:main`
- `ghcr.io/celinehan77-blip/recipe-ticket-app-v2:sha-<完整提交 SHA>`
...
```bash
WEB_IMAGE=ghcr.io/celinehan77-blip/recipe-ticket-app-v2:sha-<上一个提交 SHA> \
  docker compose -f docker-compose.ghcr.yml pull web
